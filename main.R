...
estatisticas <- dataset %>%
  summarise(
    media_mortos = mean(mortos),
    mediana_mortos = median(mortos),
    desvpad_mortos = sd(mortos),
    media_feridos_leves = mean(feridos_leves),
    mediana_feridos_leves = median(feridos_leves),
    desvpad_feridos_leves = sd(feridos_leves),
    media_veiculos = mean(veiculos),
    mediana_veiculos = median(veiculos),
    desvpad_veiculos = sd(veiculos)
  )
